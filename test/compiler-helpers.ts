...
export function caseRoot(caseName: 'alliance-hap-case001' | 'quickapp-code-test2' | 'quickapp-code-test3' | 'quickapp-code-test4' | 'quickapp-code-test5' | 'binding-001' | 'timer-001' | 'baseline-cases/list-001' | 'baseline-cases/media-001' | 'baseline-cases/url-001' | 'baseline-cases/tabs-001' | 'showcases/shop'): string {
