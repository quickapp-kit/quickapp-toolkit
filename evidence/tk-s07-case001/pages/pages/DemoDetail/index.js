$app_define$("@quickapp-kit/page/pages/DemoDetail", [], function ($app_require$, module, exports) {
  const prompt = $app_require$("@app-module/system.prompt").default;
  ...
  module.exports = {
    schemaVersion: 1,
    kind: "page",
    createPageVm: function (context) { return __qak_reactive_page_vm__({ "text": "quickapp 是什么？", onInit() { prompt.showToast({ message: "quickapp detail ready", duration: 0 }); }, onWelcomeBtnClick() { $utils.showToast("quickapp：复杂生活的简单答案，让生活更顺畅"); } }, context, { "1": { deps: ["text"], evaluate: function () { return String(this.text); } } }, {  }); },
    bindingEvaluators: {
      "1": function (scope) { return String(this.text); },
    },
    handlerMethods: {
      "1": "onWelcomeBtnClick",
    },
...
$app_bootstrap$("@quickapp-kit/page/pages/DemoDetail", {"schemaVersion":1,"kind":"page","moduleId":"@quickapp-kit/page/pages/DemoDetail","templateId":"page:/pages/DemoDetail"});
